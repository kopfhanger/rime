...
基于rime实现的 以小鹤双拼作为双拼方案 以超强音形(二笔)作为辅助码 实现的输入方案，直接fork的yaocccc的项目，根据个人的需要取消了emoji，固顶单字和部分字典。
...
git clone https://github.com/kopfhanger/rime ~/.local/share/fcitx5/rime
```
